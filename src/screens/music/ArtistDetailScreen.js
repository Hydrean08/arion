...
const styles = StyleSheet.create({
  ...
  discCard:         { backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, padding: 22 },
  discHeader:       { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  discTitle:        { color: colors.text, fontSize: 20, fontWeight: '800' },
  discClose:        { color: colors.muted, fontSize: 18, fontWeight: '700' },
  discSub:          { color: colors.muted, fontSize: 14, marginTop: 10, marginBottom: 6, lineHeight: 20 },
  discRow:          { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 11 },
  checkbox:         { width: 24, height: 24, borderRadius: 6, borderWidth: 2, borderColor: colors.border, alignItems: 'center', justifyContent: 'center' },
  checkboxOn:       { backgroundColor: colors.accent, borderColor: colors.accent },
  checkboxDisabled: { opacity: 0.4 },
  checkboxTick:     { color: '#fff', fontSize: 15, fontWeight: '900' },
  discRowText:      { color: colors.text, fontSize: 17, fontWeight: '500' },
  discRowDisabled:  { color: colors.muted },
  discActions:      { flexDirection: 'row', gap: 12, marginTop: 18 },
  discCancel:       { flex: 1, backgroundColor: colors.card, borderRadius: 24, paddingVertical: 13, alignItems: 'center' },
  discCancelText:   { color: colors.text, fontSize: 15, fontWeight: '700' },
  discDownload:     { flex: 1, backgroundColor: colors.accent, borderRadius: 24, paddingVertical: 13, alignItems: 'center' },
  discDownloadDisabled: { opacity: 0.45 },
  discDownloadText: { color: '#fff', fontSize: 15, fontWeight: '800' },
